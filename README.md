...
**如需使用简体中文或繁体中文, 请确保系统已安装简体中文字库.**

**如需使用简体中文或繁体中文, 请确保系统已安装简体中文字库.**

**如需使用简体中文或繁体中文, 请确保系统已安装简体中文字库.**

你可以使用 [SharedFontTool](https://github.com/dnasdw/SharedFontTool) 来临时安装简体中文或繁体中文字库, 也可以使用 [3DS 系统简体中文化补丁](https://tieba.baidu.com/p/6802255931) 直接将简体中文字库写入并汉化系统. 如果你的机器为中国神游版或港台版, 可直接使用.
